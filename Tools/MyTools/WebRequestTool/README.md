...
#### 3.1. 发出Http请求
> 单击下面按钮或者快捷键Alt+W
![step1](https://github.com/sunqixinxin/GreenTools/blob/master/images/HttpReuest/2.png)
![step2](https://github.com/sunqixinxin/GreenTools/blob/master/images/HttpReuest/1.png)

#### 3.1. 修改/新加一条Http request信息
> * 修改内容（想要修改一条已经存在的记录时，不要改变ConfigurationName和CategoryName;如果改了这两个值或其中一个，就会变成新增了， 是根据这两个值来判断数据是否唯一的）
* 单击下面的按钮

![step1](https://github.com/sunqixinxin/GreenTools/blob/master/images/HttpReuest/3.png)
* 右边会生成新保存的记录

#### 3.2. 删除一条Http request请求信息
> * 确认下面的信息是否是要删除的

![step1](https://github.com/sunqixinxin/GreenTools/blob/master/images/HttpReuest/8.png)

*单击下面的按钮

![step1](https://github.com/sunqixinxin/GreenTools/blob/master/images/HttpReuest/4.png)

#### 3.4. 自动保存一条http response信息
> ![step1](https://github.com/sunqixinxin/GreenTools/blob/master/images/HttpReuest/7.png)

#### 3.4. 手动保存一条http response信息
> ![step1](https://github.com/sunqixinxin/GreenTools/blob/master/images/HttpReuest/6.png)
